export const itemDescriptionList = [
  ...
  },
  {
    name: 'Blooper',
    description:
      'Only usable before Step 1. Opponents select their gear, then set aside any Heat in their hand. They shuffle the remaining cards face down and put X of them in front of them equal to their gear. Those are their cards for the turn.',
  },
  {
    name: 'Fake Block',
    description:
      'As you pass a set of item blocks, you may place a Fake Block token on that space. If a player draws items from those item blocks, there is a 20% chance they will hit the Fake Block and be forced down to first gear. Then remove the token from the board.',
  },
  {
    name: 'Banana',
    description:
  ...
  {
    name: 'Bullet Bill',
    description: 'Move 5 spaces forward, ignore turn values.',
  },
  {
    name: 'Green Shell',
    description:
  ...
  },
  {
    name: 'Star',
    description:
      'Until your next turn you have +2 to turn values and are immune to all items. (You still resolve Bananas and Fake Blocks but are not affected by them).',
  },
];
